...
export class PluginUserInteractionService extends Service {
  ...
  async processUserResponse(
    ...
    const nextMissing = dialog.request.missingVars.find((varName) => !dialog.responses[varName]);
  ...
  private async applyDialogConfiguration(dialog: ConfigurationDialog): Promise<void> {
    ...
    await this.configService.setPluginConfiguration(dialog.pluginName, dialog.responses, metadata);
