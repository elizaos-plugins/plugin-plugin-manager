...
export const pluginManagerPlugin: Plugin = {
  ...
  services: [PluginManagerService, PluginConfigurationService, PluginUserInteractionService],
  ...
  providers: [pluginStateProvider, pluginConfigurationStatusProvider, registryPluginsProvider],
